        ...
        <img src="yeezy.jpg"> 
            <nav>
                ...
                <li ><a href="index.php">Home</a></li>
                    <li class="active"><a href="yeezus.php">yeezus</a></li>
            ...
            <div class="content">
                <article class="topcontent">
                        ...
                        <content>
                                ...
                                <p>intro</p>
                                <p>download the Yeezus album</p>
                                <p><a href="yeezus.rar">download Yeezus album Zip</a></p>
