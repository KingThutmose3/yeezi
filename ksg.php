...
<html lang="en">
    <head>
        <title> Download Kid See Ghosts</title>
        <meta charset="utf-8">
        ...
        <img src="yeezy.jpg"> 
            <nav>
                ...
                <li ><a href="index.php">Home</a></li>
                    ...
                    <li class="active"><a href="ksg.php">Kids See Ghosts</a></li>
            ...
            <div class="content">
                <article class="topcontent">
                        ...
                        <content>
                                ...
                                <p>intro</p>
                                <p>download Kids See Ghosts Album album</p>
                                <p><a href="ksg.rar">download Kids See Ghosts album Zip</a></p>
