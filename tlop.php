        ...
        <img src="yeezy.jpg"> 
            <nav>
                ...
                <li ><a href="index.php">Home</a></li>
                    ...
                    <li class="active"><a href="tlop.php">TLOP</a></li>
            ...
            <div class="content">
                <article class="topcontent">
                        ...
                        <content>
                                ...
                                <p>intro</p>
                                <p>download The Life of Pablo album</p>
                                <p><a href="tlop.rar">download Life of Pablo album Zip</a></p>
