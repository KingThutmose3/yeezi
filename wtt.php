...
<html lang="en">
    <head>
        <title> Download Watch the Throne</title>
        <meta charset="utf-8">
        ...
        <img src="yeezy.jpg"> 
            <nav>
                ...
                <li ><a href="index.php">Home</a></li>
                    ...
                    <li class="active"><a href="wtt.php">Watch  The Throne </a></li>
            ...
            <div class="content">
                <article class="topcontent">
                        ...
                        <content>
                                ...
                                <p>intro</p>
                                <p>download Watch The Throne album</p>
                                <p><a href="wtt.rar">download Watch the Throne album Zip</a></p>
